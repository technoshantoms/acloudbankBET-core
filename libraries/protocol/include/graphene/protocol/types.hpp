...
GRAPHENE_DEFINE_IDS(protocol, protocol_ids, /*protocol objects are not prefixed*/,
                    ...
                    /* 1.24.x */ (tank)
                    /* 1.25.x */ (tournament)
                    /* 1.26.x */ (tournament_details)
                    /* 1.27.x */ (match)
                    /* 1.28.x */ (game)
                    /* 1.29.x */ (sport)
                    /* 1.30.x */ (event_group)
                    /* 1.31.x */ (event)
                    /* 1.32.x */ (betting_market_rules)
                    /* 1.33.x */ (betting_market_group)
                    /* 1.34.x */ (betting_market)
                    /* 1.35.x */ (bet)
                    /* 1.36.x */ (room)
                    /* 1.37.x */ (room_key_epoch)
                    /* 1.38.x */ (room_participant)
                    /* 1.39.x */ (custom_permission)
                    /* 1.40.x */ (custom_account_authority)
                    /* 1.41.x */ (offer)
                    /* 1.42.x */ (nft_metadata)
                    /* 1.43.x */ (nft)
                    /* 1.44.x */ (account_role)
